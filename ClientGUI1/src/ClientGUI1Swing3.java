...
public class ClientGUI1Swing3 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClientGUI1Swing3 window = new ClientGUI1Swing3();
	...
	private void initialize() {
		...
		lblNewLabel_1.setBounds(10, 44, 77, 15);
		chatroom_panel.add(lblNewLabel_1);
		
		JButton privatesendButton = new JButton("Send PM");
		...
		JButton privatesendButton_2 = new JButton("Confirm");
		privatesendButton_2.setBounds(75, 92, 97, 23);
		update_panel.add(privatesendButton_2);
